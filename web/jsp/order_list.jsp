...
<div class="container">
    <div class="row">
        ...
        <div style="margin:0 auto; margin-top:10px;width:950px;">
            ...
            <table class="table table-bordered">
                <c:if test="${not empty orders.productList}">
    ...
    <div style="text-align: center;">
        <ul class="pagination">
            ...
            <c:if test="${orders.currentPage != 1}">
                <li>
                    <a href="${pageContext.request.contextPath}/order?method=index&page=${orders.currentPage - 1}"
                       aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span></a>
                </li>
            </c:if>
            ...
            <c:forEach begin="1" end="${orders.totalPage}" var="page">
                <li class=""><a href="${pageContext.request.contextPath}/order?method=index&page=${page}">${page}</a>
                </li>
            </c:forEach>
